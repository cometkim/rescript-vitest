...
describe("Expect", () => {
  ...
  test("toBeNull", t => {
    t->expect(Null.null)->Expect.toBeNull
  })
  ...
  test("toThrow", t => {
    t->expect(() => throw(JsError.throwWithMessage("error")))->Expect.toThrow
  })

  test("toThrowError", t => {
    t->expect(() => throw(JsError.throwWithMessage("error")))->Expect.toThrowError(~message="error")
  })
  ...
  describe("Float", () => {
    test(
      "toBeNaN",
      t => {
        t->expect(Math.acos(2.))->Expect.Float.toBeNaN
      },
    )
  ...
  describe("Dict", () => {
    ...
    test(
      ...
      t => {
        ...
        t->expect(dict)->Expect.Dict.toMatch(Dict.fromArray([("key1", "value1"), ("key2", "value2")]))
        t->expect(dict)->Expect.Dict.toMatch(Dict.fromArray([("key1", "value1")]))
        t->expect(dict)->Expect.Dict.toMatch(Dict.fromArray([("key2", "value2")]))
        t->expect(dict)->Expect.not->Expect.Dict.toMatch(Dict.fromArray([("key1", "value2")]))
      },
    )
  })
  ...
  describe("Promise", () => {
    testAsync(
      ...
      async t => {
        ...
        await t->expect(promise())->Expect.Promise.rejects->Expect.Promise.toThrowError(~message="hi")
      },
    )
